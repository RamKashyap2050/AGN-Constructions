      ...
      translation: {
        ...
        services: [
          ...
          },
          {
            ...
            image:
              "https://www.venturaindia.com/wp-content/uploads/2025/09/office-interior-design-ideas.jpg",
            content: [
              "Professional Office Renovations for Modern, Functional Workspaces.",
              "At GN Constructions, we understand that a well-designed office is key to productivity, employee satisfaction, and making a lasting impression on clients.",
              "Our commercial renovation services focus on creating office spaces that are functional, modern, and aligned with your company's brand.",
              "Serving businesses in Montreal and surrounding areas, we specialize in transforming offices into efficient, inspiring work environments that reflect the professionalism of your business.",
            ],
            averagePrice: "Pricing varies significantly based on square footage and commercial requirements. Contact us for a detailed assessment.",
            features: [
              "Functional and efficient layout design",
              "Modern aesthetic aligned with brand identity",
              "Optimized space utilization",
              "Employee-focused comfort improvements",
            ],
            pricing: [],
            considerations: [
              "Increased Productivity: A functional layout improves focus and collaboration.",
              "Enhanced Brand Image: A modern space reinforces professionalism.",
              "Employee Retention: Prioritizing wellbeing leads to higher job satisfaction.",
            ],
          },
          {
            id: "restaurant",
            ...
            image:
              "https://static.wixstatic.com/media/1a07dc_20d4aac1b35d4d7995a39fb6d83b6917~mv2.png/v1/fill/w_568,h_318,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/1a07dc_20d4aac1b35d4d7995a39fb6d83b6917~mv2.png",
            content: [
              "Transform Your Restaurant into an Inviting, Efficient Dining Experience.",
              "At GN Constructions, we understand that a restaurant's design is as important as its menu.",
              "A well-designed space enhances the dining experience, reinforces your brand, and draws in customers.",
              "We bring expertise in creating inviting, functional, and visually appealing environments that cater to both customers and staff.",
            ],
            averagePrice: "Restaurant renovations are highly custom. Please reach out for a tailored consultation and quote.",
            features: [
              "Thoughtful, brand-focused dining area design",
              "Optimized layout for smooth staff service",
              "Strategic seating capacity expansion",
              "Inviting atmosphere creation",
            ],
            pricing: [],
            considerations: [
              "Enhanced Customer Experience: Encourages customers to stay longer and return.",
              "Improved Efficiency: Supports staff to serve customers more effectively.",
              "Increased Brand Visibility: Helps your restaurant stand out and build identity.",
              "Higher Capacity: Strategic planning can increase seating without compromising comfort.",
            ],
          },
        ],
        navHome: "Home",
        ...
        services: [
          ...
          },
          {
            ...
            image:
              "https://www.venturaindia.com/wp-content/uploads/2025/09/office-interior-design-ideas.jpg",
            content: [
              "Rénovations de bureaux professionnels pour des espaces de travail modernes et fonctionnels.",
              "Chez GN Constructions, nous comprenons qu'un bureau bien conçu est essentiel à la productivité, à la satisfaction des employés et pour faire une impression durable sur les clients.",
              "Nos services de rénovation commerciale se concentrent sur la création d'espaces de bureau fonctionnels, modernes et en harmonie avec la marque de votre entreprise.",
              "Desservant les entreprises de Montréal et des environs, nous nous spécialisons dans la transformation de bureaux en environnements de travail efficaces et inspirants qui reflètent le professionnalisme de votre entreprise.",
            ],
            averagePrice: "Les prix varient considérablement en fonction de la superficie et des exigences commerciales. Contactez-nous pour une évaluation détaillée.",
            features: [
              "Aménagement fonctionnel et efficace",
              "Esthétique moderne alignée sur l'identité de marque",
              "Optimisation de l'utilisation de l'espace",
              "Améliorations du confort axées sur les employés",
            ],
            pricing: [],
            considerations: [
              "Productivité accrue : un aménagement fonctionnel améliore la concentration et la collaboration.",
              "Image de marque améliorée : un espace moderne renforce le professionnalisme.",
              "Rétention des employés : prioriser le bien-être augmente la satisfaction au travail.",
            ],
          },
          {
            id: "restaurant",
            title: "Rénovations de Restaurants",
            image:
              "https://static.wixstatic.com/media/1a07dc_20d4aac1b35d4d7995a39fb6d83b6917~mv2.png/v1/fill/w_568,h_318,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/1a07dc_20d4aac1b35d4d7995a39fb6d83b6917~mv2.png",
            content: [
              "Transformez votre restaurant en une expérience gastronomique accueillante et efficace.",
              "Chez GN Constructions, nous comprenons que la conception d'un restaurant est tout aussi importante que son menu.",
              "Un espace bien conçu rehausse l'expérience culinaire, renforce votre marque et attire les clients.",
              "Nous apportons notre expertise pour créer des environnements invitants, fonctionnels et visuellement attrayants qui répondent à la fois aux besoins des clients et du personnel.",
            ],
            averagePrice: "Les rénovations de restaurants sont très personnalisées. Veuillez nous contacter pour une consultation et un devis sur mesure.",
            features: [
              "Conception de salle à manger réfléchie et axée sur la marque",
              "Aménagement optimisé pour un service fluide par le personnel",
              "Expansion stratégique de la capacité d'accueil",
              "Création d'une atmosphère invitante",
            ],
            pricing: [],
            considerations: [
              "Expérience client améliorée : encourage les clients à rester plus longtemps et à revenir.",
              "Efficacité accrue : aide le personnel à servir les clients plus efficacement.",
              "Visibilité de la marque : aide votre restaurant à se démarquer et à forger son identité.",
              "Plus grande capacité : une planification stratégique permet d'ajouter des places sans compromettre le confort.",
            ],
          },
        ],
        navHome: "Accueil",
